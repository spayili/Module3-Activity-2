...
// Reference from Mongodb-University repository

const { MongoClient } = require("mongodb");

async function run() {
  
  const uri = "mongodb+srv://spayiliraspberrypi:admin1234@spayili-mdw-cluster-1.xu0un4j.mongodb.net/?retryWrites=true&w=majority";
